...
const VirusColonySearchAlgorithmDetails = ({ selectedExecution }) => {
    ...
    return (
        <Paper elevation={3} style={{ padding: '20px', marginTop: '20px' }}>
            <Typography variant='h6' gutterBottom>
                Virus Colony Search Algorithm Details
            </Typography>
            <List>
                <ListItem>
                    <ListItemText
                ...
                <ListItem>
                    <ListItemText
                        primary='Sigma Value:'
                        secondary={selectedExecution.algorithmData.sigma}
                    />
                </ListItem>
...
export default VirusColonySearchAlgorithmDetails;
