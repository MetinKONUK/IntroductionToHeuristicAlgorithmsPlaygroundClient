...
const BarnaclesMatingOptimizationDetails = ({ selectedExecution }) => {
    ...
    return (
        <Paper elevation={3} style={{ padding: '20px', marginTop: '20px' }}>
            <Typography variant='h6' gutterBottom>
                Barnacles Mating Optimization Details
            </Typography>
            <List>
                <ListItem>
                    <ListItemText
                ...
                <ListItem>
                    <ListItemText
                        primary='PL Value:'
                        secondary={selectedExecution.algorithmData.pl}
                    />
                </ListItem>
...
export default BarnaclesMatingOptimizationDetails
