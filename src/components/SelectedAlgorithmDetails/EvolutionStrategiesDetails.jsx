...
const EvolutionStrategiesDetails = ({ selectedExecution }) => {
    ...
    return (
        <Paper elevation={3} style={{ padding: '20px', marginTop: '20px' }}>
            ...
            <List>
                ...
                <ListItem>
                    <ListItemText
                        primary='Lambda (lamda):'
                        secondary={selectedExecution.algorithmData.lamda}
                    />
                </ListItem>
...
export default EvolutionStrategiesDetails;
