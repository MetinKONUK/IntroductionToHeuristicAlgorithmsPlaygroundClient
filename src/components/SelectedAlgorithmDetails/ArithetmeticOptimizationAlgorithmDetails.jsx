...
const ArithmeticOptimizationAlgorithmDetails = ({ selectedExecution }) => {
    ...
    return (
        <Paper elevation={3} style={{ padding: '20px', marginTop: '20px' }}>
            <Typography variant='h6' gutterBottom>
                Arithmetic Optimization Algorithm Details
            </Typography>
            <List>
                <ListItem>
                    <ListItemText
                ...
                <ListItem>
                    <ListItemText
                        primary='Miu Value:'
                        secondary={selectedExecution.algorithmData.miu}
                    />
                </ListItem>
                <ListItem>
                    <ListItemText
                        primary='Moa Minimum Value:'
                        secondary={selectedExecution.algorithmData.moaMin}
                    />
                </ListItem>
                <ListItem>
                    <ListItemText
                        primary='Moa Maximum Value:'
                        secondary={selectedExecution.algorithmData.moaMax}
                    />
                </ListItem>
...
export default ArithmeticOptimizationAlgorithmDetails
