...
const SuccessHistoryAdaptationDEComponent = () => {
            ...
            <Paper elevation={3} sx={{ padding: 3, margin: 2, width: '40%' }}>
                <Box sx={{ textAlign: 'center', marginBottom: 2 }}>
                    <Typography variant='h4' component='h2'>
                        Success-History Adaptation Differential Evolution Parameters
                    </Typography>
                </Box>
                <FormGroup>
                    <TextField
...
export default SuccessHistoryAdaptationDEComponent
