...
const SuccessHistoryAdaptationDEReviewComponent = ({ data, index }) => {
        ...
        <Card raised sx={{ margin: 2 }}>
            <CardContent>
                ...
                <List>
                    ...
                    <ListItem>
                        <ListItemText primary='miu_f' secondary={data.miu_f} />
                    </ListItem>
                    <ListItem>
                        <ListItemText
                            primary='miu_cr'
                            secondary={data.miu_cr}
                        />
                    </ListItem>
                </List>
            </CardContent>
...
export default SuccessHistoryAdaptationDEReviewComponent
