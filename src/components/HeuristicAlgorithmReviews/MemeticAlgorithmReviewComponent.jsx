...
const MemeticAlgorithmReviewComponent = ({ data, index }) => {
        ...
        <Card raised sx={{ margin: 2 }}>
            <CardContent>
                ...
                <List>
                    ...
                    <ListItem>
                        <ListItemText primary='pc' secondary={data.pc} />
                    </ListItem>
                    <ListItem>
                        <ListItemText primary='pm' secondary={data.pm} />
                    </ListItem>
                    <ListItem>
                        <ListItemText primary='p_local' secondary={data.p_local} />
                    </ListItem>
                    <ListItem>
                        <ListItemText primary='max_local_genes' secondary={data.max_local_genes} />
                    </ListItem>
                    <ListItem>
                        <ListItemText primary='bits_per_param' secondary={data.bits_per_param} />
                    </ListItem>
                </List>
            </CardContent>
...
export default MemeticAlgorithmReviewComponent
