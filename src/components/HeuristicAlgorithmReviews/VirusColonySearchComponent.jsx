...
const VirusColonySearchReviewComponent = ({ data, index }) => {
        ...
        <Card raised sx={{ margin: 2 }}>
            <CardContent>
                ...
                <List>
                    ...
                    <ListItem>
                        <ListItemText primary='Lambda' secondary={data.lamda} />
                    </ListItem>
                    <ListItem>
                        <ListItemText primary='Sigma' secondary={data.sigma} />
                    </ListItem>
                </List>
            </CardContent>
...
export default VirusColonySearchReviewComponent
