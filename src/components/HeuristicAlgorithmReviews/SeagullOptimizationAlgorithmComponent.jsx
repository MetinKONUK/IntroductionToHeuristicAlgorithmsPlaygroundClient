...
const SeagullOptimizationAlgorithmReviewComponent = ({ data, index }) => {
        ...
        <Card raised sx={{ margin: 2 }}>
            <CardContent>
                ...
                <List>
                    ...
                    <ListItem>
                        <ListItemText primary='fc' secondary={data.fc} />
                    </ListItem>
                </List>
            </CardContent>
...
export default SeagullOptimizationAlgorithmReviewComponent
