...
const BarnaclesMatingOptimizationReviewComponent = ({ data, index }) => {
        ...
        <Card raised sx={{ margin: 2 }}>
            <CardContent>
                ...
                <List>
                    ...
                    <ListItem>
                        <ListItemText primary='pl' secondary={data.pl} />
                    </ListItem>
                </List>
            </CardContent>
...
export default BarnaclesMatingOptimizationReviewComponent
