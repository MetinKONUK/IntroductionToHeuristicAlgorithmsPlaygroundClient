...
const DifferentialEvolutionReviewComponent = ({ data, index }) => {
        ...
        <Card raised sx={{ margin: 2 }}>
            <CardContent>
                ...
                <List>
                    ...
                    <ListItem>
                        <ListItemText primary='wf' secondary={data.wf} />
                    </ListItem>
                    <ListItem>
                        <ListItemText primary='cr' secondary={data.cr} />
                    </ListItem>
                </List>
            </CardContent>
...
export default DifferentialEvolutionReviewComponent
